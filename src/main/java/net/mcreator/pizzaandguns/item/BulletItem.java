...
public class BulletItem extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:bullet")
	public static final Item block = null;
	public BulletItem(PizzaAndGunsModElements instance) {
		super(instance, 34);
	}
