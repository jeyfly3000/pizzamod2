...
public class ChocolateItem extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:chocolate")
	public static final Item block = null;
	public ChocolateItem(PizzaAndGunsModElements instance) {
		super(instance, 46);
	}
