...
import net.mcreator.pizzaandguns.entity.renderer.GunRenderer;
...
public class GunItem extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:gun")
	...
	public GunItem(PizzaAndGunsModElements instance) {
		super(instance, 7);
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("very powerful"));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 12f, 10, 10);
