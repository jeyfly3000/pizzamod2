...
public class SportyflowerBlock extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:sportyflower")
	public static final Block block = null;
	public SportyflowerBlock(PizzaAndGunsModElements instance) {
		super(instance, 36);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("sportyflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("pizza_and_guns:sportyflower"), configuredFeature);
		}
	}
	@SubscribeEvent
