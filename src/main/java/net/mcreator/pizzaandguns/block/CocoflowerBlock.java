...
public class CocoflowerBlock extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:cocoflower")
	public static final Block block = null;
	public CocoflowerBlock(PizzaAndGunsModElements instance) {
		super(instance, 43);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cocoflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("pizza_and_guns:cocoflower"), configuredFeature);
		}
	}
	@SubscribeEvent
