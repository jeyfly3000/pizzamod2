...
public class WeestyflowerBlock extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:weestyflower")
	public static final Block block = null;
	public WeestyflowerBlock(PizzaAndGunsModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("weestyflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("pizza_and_guns:weestyflower"), configuredFeature);
		}
	}
	@SubscribeEvent
