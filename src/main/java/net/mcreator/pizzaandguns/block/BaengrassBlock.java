...
public class BaengrassBlock extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:baengrass")
	public static final Block block = null;
	public BaengrassBlock(PizzaAndGunsModElements instance) {
		super(instance, 74);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("baengrass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("pizza_and_guns:baengrass"), configuredFeature);
		}
	}
	@SubscribeEvent
