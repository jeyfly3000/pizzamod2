...
public class BloodBlock extends PizzaAndGunsModElements.ModElement {
	@ObjectHolder("pizza_and_guns:blood")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("pizza_and_guns:blood_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public BloodBlock(PizzaAndGunsModElements instance) {
		super(instance, 9);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("pizza_and_guns:blocks/blood"), new ResourceLocation("pizza_and_guns:blocks/blood"))
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("pizza_and_guns:blood_lakes"), configuredFeature);
		}
	}
	@SubscribeEvent
