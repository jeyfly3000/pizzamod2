...
import net.mcreator.pizzaandguns.entity.RhinoEntity;
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RhinoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelrhino_model(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("pizza_and_guns:textures/rhino_model.png");
					}
				};
			});
		}
