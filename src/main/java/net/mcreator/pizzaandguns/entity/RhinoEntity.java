...
package net.mcreator.pizzaandguns.entity;
...
import net.mcreator.pizzaandguns.item.HornItem;
import net.mcreator.pizzaandguns.entity.renderer.RhinoRenderer;
import net.mcreator.pizzaandguns.PizzaAndGunsModElements;

@PizzaAndGunsModElements.ModElement.Tag
public class RhinoEntity extends PizzaAndGunsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("rhino").setRegistryName("rhino");
	public RhinoEntity(PizzaAndGunsModElements instance) {
		super(instance, 57);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -11513776, -10849226, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("rhino_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 15, 3, 4));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(ForgeMod.SWIM_SPEED.get(), 0.25);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(HornItem.block, (int) (1)));
		}
